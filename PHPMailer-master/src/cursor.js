...
if (ns){
	for (i = 0; i < n; i++)
		document.write('<layer name="dots'+i+'" top=0 left=0 width='+i/2+' height='+i/2+' bgcolor=#ff0000 ; pointer-events: none></layer>');
}

if (ie)
	document.write('<div id="con" style="position:absolute;top:0px;left:0px" ; pointer-events: none><div style="position:relative"; pointer-events: none>');
